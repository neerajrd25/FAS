				...
				<form id="contactform" action="" method="post" class="validateform" name="send-contact">
					...
					<div class="row">
						<div class="col-lg-3 field">
							<input type="text" name="name" placeholder="* Enter your full name" data-rule="maxlen:10" data-msg="Please enter at least 4 chars"  />
							<div class="validation">
							</div>
						</div>
						<div class="col-lg-3 field">
							<input type="number" name="phoneNumber" class="allnum" placeholder="* Enter your phone number" data-rule="phoneNumber" data-msg="Please enter a valid phone number" />
							<div class="validation">		
							</div>
						</div>
						<div class="col-lg-3 field">
				...
				<div class="col-lg-3">
					<div class="widget">
						...
						<p>
							...
							<i class="icon-envelope-alt"></i> sb.flair@gmail.com<br/>
							<i class="icon-envelope-alt"></i> hp.flair@gmail.com<br/>
						</p>
					</div>
				</div>
				<div class="col-lg-3">
