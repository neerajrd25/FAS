				...
				<div class="row">
					<div class="col-lg-12">
						<div class="row">
							...
							<div class="col-lg-3">
								<div class="box">
									<div class="box-gray aligncenter" style="padding-bottom: 40px;">
										<h4 style="margin-bottom: 39px;">MECHANICAL DESIGN</h4>
										<div class="icon">
										...
										<p class="list_style">
											...
											<i class="fa fa-chevron-right"></i>&nbsp;Design
										</p>									
									</div>
							...
							<div class="col-lg-3">
								<div class="box">
									<div class="box-gray aligncenter" style="padding-bottom: 2px;">
							...
							<div class="col-lg-3">
								<div class="box">
									<div class="box-gray aligncenter" style="padding-bottom: 0px;">
